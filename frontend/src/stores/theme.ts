...
export const useThemeStore = defineStore('theme', () => {
  ...
  function applyTheme(name: ThemeName) {
    ...
    root.style.setProperty('--destructive', '#fb4934')
    root.style.setProperty('--destructive-foreground', '#ebdbb2')
    root.style.setProperty('--muted', colors.muted)
    root.style.setProperty('--muted-foreground', colors.mutedForeground)
    root.style.setProperty('--success', '#b8bb26')
    root.style.setProperty('--success-foreground', '#282828')
    root.style.setProperty('--warning', '#fabd2f')
    root.style.setProperty('--warning-foreground', '#282828')
